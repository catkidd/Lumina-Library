...
const Navbar = () => {
  ...
  return (
    <nav className="sticky top-0 left-0 right-0 w-full z-50 bg-white/75 backdrop-blur-xl border-b border-slate-200/60 shadow-sm transition-all duration-300 py-3.5">
