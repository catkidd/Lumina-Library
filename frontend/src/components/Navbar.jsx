...
import { Library, BookOpen, Clock, Shield, LogOut, User } from 'lucide-react';
  ...
  return (
    <nav className="glass-panel sticky top-0 z-50 px-6 py-4 flex items-center justify-between shadow-xl backdrop-blur-md">
      ...
      <div className="flex items-center gap-4">
        <div className="hidden md:flex items-center gap-2 px-3 py-1.5 bg-slate-800/30 border border-slate-700/30 rounded-xl text-sm text-slate-400">
