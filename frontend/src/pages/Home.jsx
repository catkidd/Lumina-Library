      ...
      <header className="relative px-6 max-w-7xl mx-auto w-full pt-24 pb-32 z-40">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 space-y-8 text-left">
            ...
            <p className="text-slate-400 text-base md:text-lg leading-relaxed max-w-xl font-normal">
            ...
            <form onSubmit={handleSearchSubmit} className="relative max-w-xl group">
              <div className="relative flex items-center">
                <Search className="w-5.5 h-5.5 text-slate-500 absolute left-5 group-focus-within:text-indigo-400 transition-colors" />
                <input
                  type="text"
              ...
              <div className="p-6 space-y-4 flex-grow flex flex-col justify-between bg-slate-950/20">
                ...
                <div className="pt-4 border-t border-slate-900/60 flex items-center justify-between gap-3">
                  ...
                  <button
                    ...
                    className="flex items-center gap-1 text-[10px] font-bold uppercase tracking-widest text-indigo-400 hover:text-indigo-300 group-hover:translate-x-0.5 transition-all"
                  >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-6">
            {[
              ...
              { text: "The glassmorphic interface is exceptionally visually satisfying, while the underlying automated return notifications prevent overdue debts effortlessly.", author: "Eleanor Martinez", role: "Postgrad Systems Candidate", initial: "EM" }
            ].map((test, i) => (
              <div 
                key={i} 
              ...
              >
                ...
                <div className="flex items-center gap-3 border-t border-slate-900/60 pt-5 mt-6">
                  ...
                  <div>
                    <h4 className="font-bold text-slate-100 text-xs">{test.author}</h4>
      ...
      <section className="relative px-6 max-w-7xl mx-auto w-full mb-32 z-40">
        <div className="glass-panel p-10 md:p-16 rounded-[30px] border border-slate-900/70 shadow-2xl relative overflow-hidden text-center gradient-bg">
          ...
          <div className="max-w-2xl mx-auto relative z-10">
            ...
            <p className="text-slate-400 text-sm md:text-base leading-relaxed mb-10 max-w-lg mx-auto font-normal">
