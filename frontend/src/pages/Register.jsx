...
const Register = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#0b0f19] px-4 relative overflow-hidden">
      <div className="absolute top-1/4 right-1/4 w-[400px] h-[400px] bg-purple-600/10 rounded-full blur-[100px] -z-10 animate-pulse"></div>
      <div className="absolute bottom-1/4 left-1/4 w-[400px] h-[400px] bg-indigo-600/10 rounded-full blur-[100px] -z-10"></div>
      ...
      <div className="w-full max-w-md glass-panel p-8 rounded-3xl shadow-2xl relative">
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-slate-400 text-sm mt-1">Register to start borrowing books today</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            <label htmlFor="register-email" className="block text-slate-300 text-sm font-medium mb-2">Email Address</label>
          ...
          <div>
            <label htmlFor="register-password" className="block text-slate-300 text-sm font-medium mb-2">Password</label>
            <div className="relative">
              <span className="absolute inset-y-0 left-0 pl-4 flex items-center text-slate-400">
          ...
          <div>
            <label htmlFor="register-role" className="block text-slate-300 text-sm font-medium mb-2">Account Role</label>
            <div className="relative">
              <span className="absolute inset-y-0 left-0 pl-4 flex items-center text-slate-400">
              ...
              <select
                id="register-role"
                name="role"
                className="w-full pl-11 pr-4 py-3 bg-slate-950/40 border border-slate-800 focus:border-indigo-500/50 rounded-2xl text-slate-100 focus:outline-none transition-all appearance-none cursor-pointer"
                value={role}
                onChange={(e) => setRole(e.target.value)}
              >
                <option value="STUDENT" className="bg-[#0b0f19] text-slate-200">
                  Student Account
                </option>
                <option value="ADMIN" className="bg-[#0b0f19] text-slate-200">
