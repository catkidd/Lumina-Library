          ...
          <div className="glass-panel p-8 md:p-12 rounded-[24px] border border-slate-200/70 shadow-xl space-y-12 bg-white/80">
              ...
              <div className="overflow-x-auto border border-slate-200/60 rounded-xl mt-4">
                <table className="w-full border-collapse text-left text-xs">
                  ...
                  <tbody className="divide-y divide-slate-200/60 text-slate-600 bg-white">
                    ...
                    <tr>
                      <td className="p-4 font-bold text-slate-900">Standard Loan Duration</td>
                      <td className="p-4">14 Calendar Days</td>
                      <td className="p-4">Accrues fine flags; auto-email dispatched daily.</td>
                    </tr>
                    <tr>
                      <td className="p-4 font-bold text-slate-900">Overdue Fines (Accrual)</td>
            ...
            <section id="copyright-rules" className="scroll-mt-28 space-y-4">
              ...
              <ul className="space-y-3 text-slate-600 text-sm pl-4 list-disc">
                <li><strong className="text-slate-800">Personal Study Use Only:</strong> Users can download e-resources only for personal academic analysis, thesis preparation, and individual research.</li>
                <li><strong className="text-slate-800">No Commercial Syndication:</strong> Downloading large batches, bulk scraping journals, or republishing electronic files externally is strictly prohibited and constitutes a violation of copyright law.</li>
              </ul>
            </section>
            ...
            <section id="termination" className="scroll-mt-28 space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                ...
                <div className="bg-slate-50 p-5 border border-slate-200/80 rounded-xl flex gap-3">
                  <AlertTriangle className="w-5 h-5 text-indigo-600 shrink-0 mt-0.5 animate-pulse" />
                  <div>
                    <h4 className="font-bold text-slate-900 text-xs uppercase tracking-wide mb-1 font-body">Session Tampering</h4>
                    <p className="text-xs text-slate-600 leading-relaxed">Injecting script sequences, parsing backend tokens maliciously, or scanning endpoints deactivates profiles permanently.</p>
                  </div>
                </div>
              </div>
            </section>
